          ...
          <tbody className="divide-y divide-gray-100">
            {currentAnnounces.map((a) => (
              <tr key={a.id}>
                ...
                <td className="px-4 py-2">{a.image_1 ? <img src={(() => { const { src } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_1'); return src; })()} alt="img1" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} onError={(e) => { const target = e.target as HTMLImageElement; const { fallback } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_1'); if (fallback && target.src !== fallback) { target.src = fallback; } else { target.src = "/images/placeholder.png"; } }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_2 ? <img src={(() => { const { src } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_2'); return src; })()} alt="img2" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} onError={(e) => { const target = e.target as HTMLImageElement; const { fallback } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_2'); if (fallback && target.src !== fallback) { target.src = fallback; } else { target.src = "/images/placeholder.png"; } }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_3 ? <img src={(() => { const { src } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_3'); return src; })()} alt="img3" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} onError={(e) => { const target = e.target as HTMLImageElement; const { fallback } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_3'); if (fallback && target.src !== fallback) { target.src = fallback; } else { target.src = "/images/placeholder.png"; } }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_4 ? <img src={(() => { const { src } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_4'); return src; })()} alt="img4" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} onError={(e) => { const target = e.target as HTMLImageElement; const { fallback } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_4'); if (fallback && target.src !== fallback) { target.src = fallback; } else { target.src = "/images/placeholder.png"; } }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_5 ? <img src={(() => { const { src } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_5'); return src; })()} alt="img5" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} onError={(e) => { const target = e.target as HTMLImageElement; const { fallback } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_5'); if (fallback && target.src !== fallback) { target.src = fallback; } else { target.src = "/images/placeholder.png"; } }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_6 ? <img src={(() => { const { src } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_6'); return src; })()} alt="img6" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} onError={(e) => { const target = e.target as HTMLImageElement; const { fallback } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'image_6'); if (fallback && target.src !== fallback) { target.src = fallback; } else { target.src = "/images/placeholder.png"; } }} /> : "—"}</td>
                ...
                <td className="px-4 py-2">{a.products_default_cover ? <img src={(() => { const { src } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'products_default_cover'); return src; })()} alt="default cover" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} onError={(e) => { const target = e.target as HTMLImageElement; const { fallback } = getAnnouncesImageWithFallback(a as unknown as Record<string, unknown>, 'products_default_cover'); if (fallback && target.src !== fallback) { target.src = fallback; } else { target.src = "/images/placeholder.png"; } }} /> : "—"}</td>
