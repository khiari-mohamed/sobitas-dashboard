          ...
          <tbody className="divide-y divide-gray-100">
            {currentAnnounces.map((a) => (
              <tr key={a.id}>
                ...
                <td className="px-4 py-2">{a.image_1 ? <img src={a.image_1.startsWith('/') ? a.image_1 : `/${a.image_1}`} alt="img1" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_2 ? <img src={a.image_2.startsWith('/') ? a.image_2 : `/${a.image_2}`} alt="img2" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_3 ? <img src={a.image_3.startsWith('/') ? a.image_3 : `/${a.image_3}`} alt="img3" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_4 ? <img src={a.image_4.startsWith('/') ? a.image_4 : `/${a.image_4}`} alt="img4" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_5 ? <img src={a.image_5.startsWith('/') ? a.image_5 : `/${a.image_5}`} alt="img5" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} /> : "—"}</td>
                <td className="px-4 py-2">{a.image_6 ? <img src={a.image_6.startsWith('/') ? a.image_6 : `/${a.image_6}`} alt="img6" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} /> : "—"}</td>
                ...
                <td className="px-4 py-2">{a.products_default_cover ? <img src={a.products_default_cover.startsWith('/') ? a.products_default_cover : `/${a.products_default_cover}`} alt="default cover" width={100} height={60} className="object-contain border rounded" style={{ display: 'block', margin: '0 auto' }} /> : "—"}</td>
