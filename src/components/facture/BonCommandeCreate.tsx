...
export default function BonCommandeCreate() {
  ...
  const updateItem = (index: number, field: keyof BCItem, value: string | number) => {
  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-lg max-w-6xl mx-auto mt-6">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">BON DE COMMANDE</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            <input
              type="text"
              value={bcInfo.numero}
              onChange={(e) => setBcInfo({...bcInfo, numero: e.target.value})}
          ...
          <div>
            ...
            <input
              type="date"
              value={bcInfo.date_livraison}
              onChange={(e) => setBcInfo({...bcInfo, date_livraison: e.target.value})}
              className="w-full border rounded px-3 py-2"
            />
          </div>
          <div>
        ...
        {/* Items */}
        <div>
          <h3 className="text-lg font-semibold mb-4 border-b pb-2">Articles Commandés</h3>
        ...
        <div>
          ...
          <textarea
            value={bcInfo.note}
            onChange={(e) => setBcInfo({...bcInfo, note: e.target.value})}
            className="w-full border rounded px-3 py-2"
            rows={3}
