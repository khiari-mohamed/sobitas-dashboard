...
import { createCoordinate } from "@/services/coordinates";
...
export default function CoordinatesCreateClient() {
  ...
  return (
    <div className="bg-white p-8 shadow-xl w-full max-w-[1600px] mx-auto mt-8 border">
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Ajouter une nouvelle coordonnée</h1>
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="col-span-1 md:col-span-2">
          <button type="submit" className="w-full mt-8 bg-green-600 hover:bg-green-700 text-white font-bold py-4 text-xl border-none" disabled={loading}>
            {loading ? "Création..." : "Créer la coordonnée"}
          </button>
        </div>
      </form>
    </div>
